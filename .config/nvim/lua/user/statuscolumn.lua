-- Taken from LazyVim's statuscolumn implementation
-- Allows gitsigns and diagnostics to show separately on the status column
-- REF: https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/util/ui.lua
